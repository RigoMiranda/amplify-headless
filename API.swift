...
public final class CreateTaskMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateTask: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, title: String, description: String? = nil, status: String? = nil, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "Task", "id": id, "title": title, "description": description, "status": status, "createdAt": createdAt, "updatedAt": updatedAt])
      }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateNote: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, content: String, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "Note", "id": id, "content": content, "createdAt": createdAt, "updatedAt": updatedAt])
      }
